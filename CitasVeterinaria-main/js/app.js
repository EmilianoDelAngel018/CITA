...
function nuevaCita(e) { 
    ...
    ui.imprimirCitas(admonCitas)
        //reinicia el objeto para evitar futuros problemas 
    reiniciarObjeto()
...
function eliminarCita(id) { 
    admonCitas.eliminarCita(id) 
    ui.imprimirCitas(admonCitas)
    ui.imprimirAlerta('CITA ELIMINADA EXITOSAMENTE') //AVISO ELIMINACION DE CITA
}
